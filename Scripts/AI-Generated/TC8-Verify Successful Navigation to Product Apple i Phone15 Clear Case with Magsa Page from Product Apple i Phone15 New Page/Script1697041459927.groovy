...
'step 4: At Page product apple-iphone-15-clear-case-with-magsa click on button object'
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify Successful Navigation to Product Apple i Phone15 Clear Case with Magsa Page from Product Apple i Phone15 New Page_visual_checkpoint')
